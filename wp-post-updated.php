...

{
...

    {
        ...
        add_menu_page('WP Post Updated', 'WP Post Updated', 'manage_options', 'wp-post-updated', array($this, 'menu_html'));
    ...
    public function menu_html()
    {
        ...
        echo '<h2>' . _e('Hello, Many thanx to use this plugin', 'thfo_wppu'); ?> </h2>
        <h2><?php _e('If You Enjoy this plugin... encourage me!', 'thfo_wppu') ?></h2>
